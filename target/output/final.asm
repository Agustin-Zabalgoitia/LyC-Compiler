...
_Prueba_funcion_equalExpressio	db	"--- Prueba funcion equalExpressions() ---$"	,0
_4	dd	4.0
_Se_evaluaran_c1_c2_y_c3	db	"Se evaluaran c1 , c2 y c3$"	,0
_c1_2_2	db	"c1 -> 2 + 2$"	,0
_c2_4	db	"c2 -> 4$"	,0
_c3_1_3	db	"c3 -> 1 + 3$"	,0
auxEE1	dd	?
auxEE2	dd	?
auxEE3	dd	?
_Alguna_de_las_expresiones_es_	db	"Alguna de las expresiones es igual a otra$"	,0
_Ninguna_expresion_es_igual_a_	db	"Ninguna expresion es igual a otra$"	,0
...
displayString _
newLine 
displayString _Prueba_funcion_equalExpressio
newLine 
fld _2 
fld _2 
fadd
...
ffree st(0)
fstp c3 
displayString _Se_evaluaran_c1_c2_y_c3
newLine 
displayString _c1_2_2
newLine 
displayString _c2_4
newLine 
displayString _c3_1_3
newLine 
fld c1 
fstp auxEE1 
...
jne et_331
et_327:
displayString _Alguna_de_las_expresiones_es_
newLine 
jmp et_333
et_331:
displayString _Ninguna_expresion_es_igual_a_
newLine 
et_333:
MOV AX, 4C00h
INT 21h
